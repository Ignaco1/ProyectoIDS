...
{
    public partial class Form_motivosCancelacionMantenimiento : Form
    {
        CONTROLADORA.Controladora_motivosCancelacionMantenimiento contro_moti = new CONTROLADORA.Controladora_motivosCancelacionMantenimiento();
        CONTROLADORA.Controladora_AsignacionesMantenimiento contro_asig = new CONTROLADORA.Controladora_AsignacionesMantenimiento();
        private AsignacionMantenimiento asignacion;
        public bool MotivosAsignadosCorrectamente { get; private set; } = false;

        public Form_motivosCancelacionMantenimiento(AsignacionMantenimiento asignacionSeleccionada)
        {
            InitializeComponent();
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            var motivosSeleccionados = checkedListBox_motivos.CheckedItems.OfType<MotivoCancelacionMantenimiento>().ToList();
            ...
            try
            {
                ...
                string respuesta = contro_asig.AgregarMotivoACancelacion(asignacion.AsignacionMantenimientoId, motivosSeleccionados);
