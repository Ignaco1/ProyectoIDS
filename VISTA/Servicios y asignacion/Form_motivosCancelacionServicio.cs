...
{
    public partial class Form_motivosCancelacionServicio : Form
    {
        CONTROLADORA.Controladora_motivosCancelacionServicios contro_moti = new CONTROLADORA.Controladora_motivosCancelacionServicios();
        ...
        public Form_motivosCancelacionServicio(AsignacionServicio asignacionSeleccionada)
        {
            InitializeComponent();
        ...
        private void btn_guardar_Click(object sender, EventArgs e)
        {
            ...
            var motivosSeleccionados = checkedListBox_motivos.CheckedItems.OfType<MotivoCancelacionServicio>().ToList();
            ...
            try
            {
                ...
                string respuesta = contro_asig.AgregarMotivoACancelacion(asignacion.AsignacionServicioId, motivosSeleccionados);
